...
export default function ShineBorder({
  ...
  return (
    <div
      ...
      className={cn(
        "relative grid min-h-[60px] w-fit min-w-[300px] place-items-center rounded-[--border-radius]  bg-[#F0EAF5] p-3 shadow text-black dark:bg-transparent dark:text-white",
        className
      )}>
      <div
        style={
